...
namespace PS4_TAApplication.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new TAUser { UserName = Input.Email, Email = Input.Email, uNumber = Input.UniversityIdentification };
